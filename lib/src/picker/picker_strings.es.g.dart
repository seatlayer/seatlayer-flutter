...
const SeatLayerPickerStrings seatLayerPickerStringsEs = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Asiento de pasillo para transferencia',
    'step-free': 'Asiento accesible sin escalones',
    'hearing': 'Escucha asistida',
    'cart': 'Subtítulos en directo (CART)',
    'sign-language': 'Vista de lengua de signos',
    'low-vision': 'Vista para personas ciegas o con baja visión',
    'sensory-friendly': 'Asientos tranquilos y sensorialmente amables',
    'plus-size': 'Asiento de talla grande',
