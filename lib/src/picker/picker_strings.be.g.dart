...
const SeatLayerPickerStrings seatLayerPickerStringsBe = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'companion': 'Месца для суправаджэння',
    'semi-ambulatory': 'Абмежаваная рухомасць',
    'designated-aisle': 'Месца ля праходу для перасадкі',
    'step-free': 'Даступнае месца без прыступак',
    'hearing': 'Падтрымка слыху',
    'cart': 'Жывыя субцітры (CART)',
    'sign-language': 'Агляд жэставай мовы',
    'low-vision': 'Прагляд для нязрячых і слабабачных',
    'sensory-friendly': 'Ціхія сенсорна камфортныя месцы',
