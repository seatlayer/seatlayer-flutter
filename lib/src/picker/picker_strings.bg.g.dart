...
const SeatLayerPickerStrings seatLayerPickerStringsBg = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    'wheelchair': 'Място за инвалидна количка',
    'companion': 'Място за придружител',
    'semi-ambulatory': 'Ограничена подвижност',
    'designated-aisle': 'Място до пътеката за прехвърляне',
    'step-free': 'Достъпно място без стъпала',
    'hearing': 'Помощно слушане',
    'cart': 'Субтитри на живо (CART)',
    'sign-language': 'Изглед към жестомимичен превод',
    'low-vision': 'Гледане за незрящи и слабовиждащи',
    'sensory-friendly': 'Тихи, сензорно щадящи места',
