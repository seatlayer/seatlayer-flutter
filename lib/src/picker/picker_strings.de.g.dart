...
const SeatLayerPickerStrings seatLayerPickerStringsDe = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Gangplatz zum Umsetzen',
    'step-free': 'Stufenlos barrierefreier Platz',
    'hearing': 'Höranlage',
    'cart': 'Live-Untertitel (CART)',
    'sign-language': 'Sicht auf Gebärdensprache',
    'low-vision': 'Für blinde und sehbehinderte Gäste',
    'sensory-friendly': 'Ruhiger, reizarmer Sitzbereich',
    'plus-size': 'Extrabreiter Sitzplatz',
