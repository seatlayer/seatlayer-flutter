...
const SeatLayerPickerStrings seatLayerPickerStringsDa = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Anvist gangplads til overflytning',
    'step-free': 'Trinfri tilgængelig plads',
    'hearing': 'Teleslynge',
    'cart': 'Live-tekstning (CART)',
    'sign-language': 'Udsyn til tegnsprogstolk',
    'low-vision': 'Visning for blinde og svagsynede',
    'sensory-friendly': 'Rolige, sansevenlige pladser',
    'plus-size': 'Ekstra bred plads',
