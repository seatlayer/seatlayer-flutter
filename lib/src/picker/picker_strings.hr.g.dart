...
const SeatLayerPickerStrings seatLayerPickerStringsHr = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    'wheelchair': 'Mjesto za invalidska kolica',
    'companion': 'Mjesto za pratnju',
    'semi-ambulatory': 'Ograničena pokretljivost',
    'designated-aisle': 'Mjesto uz prolaz za premještaj',
    'step-free': 'Pristupačno mjesto bez stepenica',
    'hearing': 'Pomoć pri slušanju',
    'cart': 'Titlovi uživo (CART)',
    'sign-language': 'Pogled na znakovni jezik',
    'low-vision': 'Gledanje za slijepe i slabovidne',
    'sensory-friendly': 'Tiha, osjetilno prilagođena mjesta',
