...
const SeatLayerPickerStrings seatLayerPickerStringsUk = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Місце біля проходу для пересадки',
    'step-free': 'Доступне місце без сходинок',
    'hearing': 'Підтримка слуху',
    'cart': 'Субтитри в реальному часі (CART)',
    'sign-language': 'Огляд жестової мови',
    'low-vision': 'Перегляд для незрячих і слабозорих',
    'sensory-friendly': 'Тихі, сенсорно комфортні місця',
