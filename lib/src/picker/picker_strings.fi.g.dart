...
const SeatLayerPickerStrings seatLayerPickerStringsFi = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Käytäväpaikka siirtymistä varten',
    'step-free': 'Portaaton esteetön paikka',
    'hearing': 'Induktiosilmukka',
    'cart': 'Livetekstitys (CART)',
    'sign-language': 'Näkymä viittomakielelle',
    'low-vision': 'Katselu sokeille ja heikkonäköisille',
    'sensory-friendly': 'Rauhalliset, aistiystävälliset paikat',
