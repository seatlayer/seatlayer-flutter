...
const SeatLayerPickerStrings seatLayerPickerStringsSk = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Vyhradené miesto pri uličke na presun',
    'step-free': 'Bezbariérové miesto bez schodov',
    'hearing': 'Podpora počutia',
    'cart': 'Živé titulky (CART)',
    'sign-language': 'Výhľad na posunkový jazyk',
    'low-vision': 'Sledovanie pre nevidiacich a slabozrakých',
    'sensory-friendly': 'Tiché, zmyslovo šetrné miesta',
