...
const SeatLayerPickerStrings seatLayerPickerStringsLt = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Vieta prie tako persėdimui',
    'step-free': 'Pritaikyta vieta be laiptelių',
    'hearing': 'Klausos pagalba',
    'cart': 'Tiesioginiai subtitrai (CART)',
    'sign-language': 'Gestų kalbos matomumas',
    'low-vision': 'Žiūrėjimas akliesiems ir silpnaregiams',
    'sensory-friendly': 'Ramios, jusliškai draugiškos vietos',
