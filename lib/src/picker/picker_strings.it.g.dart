...
const SeatLayerPickerStrings seatLayerPickerStringsIt = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Posto sul corridoio per il trasferimento',
    'step-free': 'Posto accessibile senza gradini',
    'hearing': 'Ausilio all’ascolto',
    'cart': 'Sottotitoli in diretta (CART)',
    'sign-language': 'Vista sulla lingua dei segni',
    'low-vision': 'Visione per ciechi e ipovedenti',
    'sensory-friendly': 'Posti tranquilli e sensorialmente accessibili',
    'plus-size': 'Posto di taglia grande',
