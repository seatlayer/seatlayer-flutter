...
const SeatLayerPickerStrings seatLayerPickerStringsSl = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    'wheelchair': 'Mesto za invalidski voziček',
    'companion': 'Spremljevalni sedež',
    'semi-ambulatory': 'Omejena gibljivost',
    'designated-aisle': 'Sedež ob prehodu za presedanje',
    'step-free': 'Dostopen sedež brez stopnic',
    'hearing': 'Podpora sluhu',
    'cart': 'Podnapisi v živo (CART)',
    'sign-language': 'Pogled na znakovni jezik',
    'low-vision': 'Ogled za slepe in slabovidne',
    'sensory-friendly': 'Tihi, čutno prijazni sedeži',
