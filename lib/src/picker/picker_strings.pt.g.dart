...
const SeatLayerPickerStrings seatLayerPickerStringsPt = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Lugar no corredor para transferência',
    'step-free': 'Lugar acessível sem degraus',
    'hearing': 'Apoio à audição',
    'cart': 'Legendagem em direto (CART)',
    'sign-language': 'Vista para a língua gestual',
    'low-vision': 'Visualização para cegos e baixa visão',
    'sensory-friendly': 'Lugares calmos e sensorialmente adaptados',
    'plus-size': 'Lugar de tamanho grande',
