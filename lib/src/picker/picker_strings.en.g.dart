...
const SeatLayerPickerStrings seatLayerPickerStringsEn = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'semi-ambulatory': 'Semi-ambulatory (limited mobility)',
    'designated-aisle': 'Designated aisle / transfer seat',
    'step-free': 'Step-free accessible seat',
    'hearing': 'Assistive listening',
    'cart': 'CART live-caption view',
    'sign-language': 'Sign-language view',
    'low-vision': 'Blind / low-vision viewing',
    'sensory-friendly': 'Quiet / sensory-friendly seating',
