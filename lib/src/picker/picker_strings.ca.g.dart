...
const SeatLayerPickerStrings seatLayerPickerStringsCa = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Seient de passadís per a transferència',
    'step-free': 'Seient accessible sense escales',
    'hearing': 'Escolta assistida',
    'cart': 'Subtítols en directe (CART)',
    'sign-language': 'Vista de llengua de signes',
    'low-vision': 'Vista per a ceguesa o baixa visió',
    'sensory-friendly': 'Seients tranquils i sensorialment amables',
    'plus-size': 'Seient de talla gran',
