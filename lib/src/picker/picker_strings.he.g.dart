...
const SeatLayerPickerStrings seatLayerPickerStringsHe = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'מושב מעבר ייעודי להעברה',
    'step-free': 'מושב נגיש ללא מדרגות',
    'hearing': 'עזר שמיעה',
    'cart': 'כתוביות בזמן אמת (CART)',
    'sign-language': 'תצפית על שפת הסימנים',
    'low-vision': 'צפייה לעיוורים ולקויי ראייה',
    'sensory-friendly': 'מושבים שקטים וידידותיים לחושים',
    'plus-size': 'מושב רחב',
