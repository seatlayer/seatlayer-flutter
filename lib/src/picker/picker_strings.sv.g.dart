...
const SeatLayerPickerStrings seatLayerPickerStringsSv = SeatLayerPickerStrings(
  ...
  accessNeeds: <String, String>{
    ...
    'designated-aisle': 'Anvisad gångplats för överflyttning',
    'step-free': 'Trappfri tillgänglig plats',
    'hearing': 'Hörslinga',
    'cart': 'Livetextning (CART)',
    'sign-language': 'Sikt mot teckenspråkstolk',
    'low-vision': 'Visning för blinda och synsvaga',
    'sensory-friendly': 'Lugna, sinnesvänliga platser',
    'plus-size': 'Extra bred plats',
